...
public class LeachNode extends Node {
	...
	/** N˙mero de Cluster Heads ativos. */
	public static int NUMEROS_DE_CH = 0;

	/** N˙mero total de Nos na simulacao. */
	...
	/** N˙mero de slots de tempo para a configuracao TDMA. */
	...
	public void matarNo() {
		...
		//Checa se o nÛ estiver vivo
		if(this.isVivo()) {
			//Houve ocorrencias onde um nÛ morto estava sendo morto denovo, 
			//ent„o foi colocada esta condiÁ„o na funÁ„o.
			CustomGlobal.NUM_NOS_VIVOS--;//Decrementa um no numero de nÛs vivos
		}
		
		//Seta as variaveis como padr„o de um nÛ morto
		setBandeira(CustomGlobal.BANDEIRA_LIVRE);
		tamanhoTDMA = -1;
		slotTDMA = -1;
	...
	public void transformarNoEmClusterHead() {
		...
		// Incrimenta o N˙mero de CH, devido ao limite de CHs ao mesmo tempo.
		NUMEROS_DE_CH++;
	...
	public String toString() {
		...
		String me = "";
		me += "SIMULACAO DO LEACH - STATUS DE N”\n";
		me += "Leach Node ID:		" + ID + "\n";
		me += "Funcao:				" + getFuncao() + "\n";
